...
App.loopThroughArray = function (data) {
  ...
  var markerCluster = new MarkerClusterer(App.map, App.markers, { imagePath: 'https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/m' });
};
